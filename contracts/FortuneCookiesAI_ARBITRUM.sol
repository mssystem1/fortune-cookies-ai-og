...
/// @title FortuneCookiesAI_Arbitrum
/// @notice Arbitrum version of FortuneCookiesAI for Cookieverse.
...
contract FortuneCookiesAI_Arbitrum is ERC721, Ownable, ERC2981, ReentrancyGuard {
    ...
    constructor() ERC721("Fortune Cookies AI on Arbitrum", "COOKIEAI") Ownable(msg.sender) {
        mintPrice = 0;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if (bytes(imageURI).length > 0) {
            string memory jsonWithImage = Base64.encode(
                abi.encodePacked(
                    ...
                    '","description":"Cookieverse AI fortune or Wallet Roast image NFT minted on Arbitrum.",',
                    '"attributes":[',
        ...
        string memory jsonOnchain = Base64.encode(
            abi.encodePacked(
                '{"name":"COOKIE #', tokenId.toString(),
                '","description":"AI-generated fortune minted on Arbitrum. On-chain SVG inspired by Arbitrum glass design.",',
                '"attributes":[',
                    '{"trait_type":"Product","value":"Cookieverse"},',
                    '{"trait_type":"Network","value":"Arbitrum"},',
    ...
    function _svgBrand(uint256 tokenId) internal pure returns (string memory) {
        return string.concat(
            ...
            "<text x='400' y='418' text-anchor='middle' fill='#F7F0FF' fill-opacity='0.9' font-family='Arial, Helvetica, sans-serif' font-size='17' font-weight='500' letter-spacing='0.12em'>AI FORTUNE ON ARBITRUM</text>",
